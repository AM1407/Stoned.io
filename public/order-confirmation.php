...
$isPaid    = false;
$sessionId = $_GET['session_id'] ?? ($order['stripe_session_id'] ?? '');
...
if ($sessionId) {
    try {
        ...
        // Invalid session — leave $isPaid = false
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Payment ── */
        .pay-block { background: rgba(80,200,120,0.07); border: 1px solid rgba(80,200,120,0.22); border-radius: 10px; padding: 24px; }
        ...
        .pay-block.unpaid { background: rgba(255,94,91,0.07); border: 1px solid rgba(255,94,91,0.22); }
...
<div class="confirm-wrap">
    ...
    <!-- ── Payment Status ── -->
    <div class="section-card">
        <h2><i class="bi bi-credit-card-2-front-fill" style="color:<?= $isPaid ? '#50c878' : '#FF5E5B' ?>;"></i> Payment</h2>
        <?php if ($isPaid): ?>
        <div class="pay-block">
            <h3><i class="bi bi-check-circle-fill" style="color:#50c878;"></i> Payment Complete</h3>
            <p>Your payment of <?= $orderTotal ?>&euro; has been confirmed. Your downloads are ready below.</p>
        </div>
        <?php else: ?>
        <div class="pay-block unpaid">
            <h3><i class="bi bi-exclamation-triangle-fill" style="color:#FF5E5B;"></i> Payment Not Confirmed</h3>
            <p>We couldn&rsquo;t verify your payment. If you cancelled the checkout, you can try again from your cart.</p>
            <a href="cart.php" style="color:#c9a96e; font-size:0.85rem; font-weight:600;">
    ...
    <div class="section-card" id="docs-section">
        ...
        <div class="pending-block">
            <h3>Payment required to unlock downloads</h3>
            <p>Complete your payment to access your rock documents. <a href="cart.php" style="color:#c9a96e;">Return to cart</a> to try again.</p>
        </div>
        <?php else: ?>
